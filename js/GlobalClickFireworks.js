...
const FIREWORK_PALETTE = ['#e9fffb', '#b5f1e9', '#78d6c6', '#88a6ff', '#dce8ff'];
...
function createSparkTexture() {
  ...
  gradient.addColorStop(0.12, 'rgba(233, 255, 251, 0.96)');
  gradient.addColorStop(0.28, 'rgba(181, 241, 233, 0.72)');
  gradient.addColorStop(0.48, 'rgba(120, 214, 198, 0.18)');
  gradient.addColorStop(0.68, 'rgba(120, 214, 198, 0.04)');
  gradient.addColorStop(1.0, 'rgba(120, 214, 198, 0)');
