...
构建站点后，在桌面和移动端宽度检查：首页简介与头像、News、Selected Publications、Notes、Daily 是否正常排列。Daily 轮播应只包含 `assets/hero-slides/1.jpg`、`2.jpg`、`3.jpg` 三张图片，左右按钮可循环切换，浏览器控制台没有 JavaScript 或 WebGL 异常。
